...
const Collections: React.FC<CollectionsProps> = ({
  ...
  // "Almost There" — recipes missing 3 or fewer pantry ingredients
    ...
    return recipes
      .map(recipe => {
        const missing = recipe.ingredients.filter(
          ing => !inStockNames.has(ing.name.toLowerCase().trim())
        );
  ...
  // Cooked history — sorted newest first, deduplicated display
  ...
  return (
    <>
      <div className="bg-[#000000] min-h-screen text-white flex flex-col font-sans max-w-[480px] mx-auto">
        ...
        {/* Section tabs */}
        <div className="sticky top-[72px] z-10 px-4 pt-3 pb-1 bg-[#000000]/95 backdrop-blur-md border-b border-white/5">
          ...
          {activeSection === 'almostThere' && (
            <div className="px-4 pt-6">
              <div className="mb-6">
                ...
                <p className="text-[#b6baa1] text-sm font-medium leading-relaxed">
                  Recipes you can make with {pantry.length > 0 ? 'just a few more ingredients' : 'ingredients from your pantry'}.
                </p>
              </div>
