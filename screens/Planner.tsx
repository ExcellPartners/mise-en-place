...
const Planner: React.FC<PlannerProps> = ({ 
  ...
  return (
    <div className="flex h-screen w-full flex-col bg-[#1c1d15] text-white font-display w-full relative overflow-hidden">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 px-4 pt-3 bg-gradient-to-t from-[#1c1d15] via-[#1c1d15]/95 to-transparent"
        ...
        <button 
          ...
          className="w-full bg-[#636b2f] text-white font-bold py-4 rounded-2xl flex items-center justify-center gap-2 shadow-lg shadow-[#636b2f]/20 active:scale-[0.98] transition-all pointer-events-auto"
        >
      ...
      {showSummary && (
        <div className="fixed inset-0 z-[250] bg-[#1c1d15] flex flex-col animate-in slide-in-from-bottom duration-300 w-full">
          ...
          <footer className="p-6 border-t border-white/5 bg-[#1c1d15] space-y-3">
            ...
            <button 
              onClick={() => { setShowSummary(false); setTimeout(() => onClearItinerary?.(), 100); }} 
